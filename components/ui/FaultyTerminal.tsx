...
export default function FaultyTerminal({
  ...
  // Modified to use window coordinates for when it's behind a pointer-events-none layer
  ...
  useEffect(() => {
    ...
    // Set clear color to transparent so our main background can still affect things if needed, or black
    ...
    // Bind to window so it reacts globally
